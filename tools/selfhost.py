...
LIBRARIES = {
    ...
    "types": compiler_module(
        "luna.compiler.types",
        "middleend/types/storage",
        "middleend/types/traits",
        "middleend/types/construction",
        "middleend/types/mutation",
    ...
    "sem_generic_model": compiler_module(
        ...
        "middleend/semantic/generics/storage",
    ...
    "sem_ctx": compiler_module(
        ...
        "middleend/semantic/context/lowering",
    ),
    ...
    "x86_64_codegen": compiler_module(
        ...
        "backend/x86_64/codegen/conversion",
        "backend/x86_64/codegen/call",
        "backend/x86_64/codegen/callee",
    ...
    "x86_64_linker": compiler_module(
        "luna.compiler.x86.linker",
        "backend/x86_64/linker/symbols",
        "backend/x86_64/linker/layout",
        "backend/x86_64/linker/relocation",
