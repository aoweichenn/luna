...
| `anchor/` | promoted through the object-oriented ELF stage-fixed `luna` toolchain |
...
| x86-64 backend modernization | contracted modules plus RAII Assembler, ELF I/O and StaticLinker landed; 443/443 and fixed point |
