...
| `anchor/` | promoted to the contracted-backend stage-fixed `luna` toolchain |
...
| x86-64 backend module contraction | 20 modules reduced to six; 443/443 cases; verify fixed point |
